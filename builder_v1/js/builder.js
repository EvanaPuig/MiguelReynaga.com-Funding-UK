...
editableItems['.color-orange-2'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.color-orange-1'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.color-black-1'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.color-green-1'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.color-red-1'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.color-white'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['.footer a'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['span'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['li'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['a:hover'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];
editableItems['a'] = ['color', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom'];


editableItems['div'] = ['background-image', 'background-color', 'background', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom'];
editableItems['h6'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['h5'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['h4'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['h3'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['h2'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['h1'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['ol'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['ul'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['li'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['span'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['p'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['a:hover'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['a'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['input'] = ['background', 'background-color', 'color', 'font-size', 'font-family', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom', 'text-align'];
editableItems['input'] = ['type', 'name'];
...
function closeStyleEditor() {
	...
	if( $('.styleEditor').css('left') == '0px' ) {
		...
		$('#pageList ul li iframe').each(function(){
			...
			for( var key in editableItems ) {
                $(this).contents().find( pageContainer + ' '+ key ).css({'outline': '', 'cursor': ''});
                // TODO: it realy need? This code overloads the process
            ...
            //
				//	for( var key in editableItems ) {
            //
            //            console.info(pageContainer + ' '+ key);
				//		$(this).contents().find( pageContainer + ' '+ key ).hover( function(e){
            //
				//			e.stopPropagation();
            //
...
function activeStyling() {
    $('#pageList ul li iframe').each(function(){
        ...
        for( var key in editableItems ) {
            ...
            $(this).contents().find( pageContainer + ' '+ key ).unbind('click').unbind('hover');
...
$(function(){
	...
	$('#menu .panel-btn').toggle(
	function(){$('#menu').stop().animate({'left': '0px'}, 500);},
	function(){$('#menu').stop().animate({'left': '-210px'}, 500);});
    ...
    $('#TempModal').on('show.bs.modal', function () {
        if(!emptyMarker) {
    ...
    $("#tempImportForm").submit(function(){
    ...
    $("#saveprojPage").on('click', function(e) {
        ...
        $("#Templatedata").val(JSON.stringify(jsonData));
        //$("#Templatedata").attr({"value": JSON.stringify(jsonData)});

        $("#tempExportForm").submit();
    });
